...
void loop() {
  ...
  if(digitalRead(BUTTON_PIN) == LOW) {
      // Logika tombol bisa diisi nanti
  }
...
void prosesAbsen(String qr) {
  String pathUser = String("/users/") += qr;
  ...
  if (Firebase.getString(fbdo, pathUser)) {
    ...
    String pathLog = String("/logs/") += String(millis()); 
